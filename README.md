...
These factors are accounted for when I generate the board graph.  Below is an example of a 4x4 board with special tiles with the directed weighted edges of (2,1) displayed.

![4x4 special grid graph](https://github.com/pequnio3/board/blob/master/special_board.jpg)
...
Below is a visualization of the algorithm on a 32x32 board.
![4x4 special grid graph](https://github.com/pequnio3/board/blob/master/knighttour.jpg)
...
Below is a visualization of how this special case of the the algorithm would work
![4x4 special grid graph](https://github.com/pequnio3/board/blob/master/knighttour2.jpg)
